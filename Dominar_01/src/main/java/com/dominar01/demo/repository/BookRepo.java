...
public interface BookRepo extends JpaRepository<Book, Integer> {
     ...
     * Cuando declaras Book findByTitle(String title), Spring interpreta que quieres
     * buscar en la columna title de la tabla book.
     ...
     * Esa clase sabe cómo conectarse a la base de datos y ejecutar la consulta
     * equivalente a:
    ...
    @Query(value = "CALL sp_listarPrimeros_10()", nativeQuery = true) // ¡True! Porque es SQL puro.
